  ...
  async exec(msg) {
    ...
    */
    ...
    msg.guild.members.get(id)
      .addRole(reward.addrank);
    ["341143713625669632", "341143798832693248", "341143817552134154", "341143835604156428", "341143849646686211"].filter(i => i !== reward.addrank)
      .map(i => msg.guild.members.get(id)
        .removeRole(i))
    if (reward.reward) {
